              ...
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="side-menu">
                      <li class="active sidebar-layout">
                          <a href="../backend/home.php" class="svg-icon">
                              <i class="">
                      ...
                      <li class="px-3 pt-3 pb-2">
                       ...
                       <li class=" sidebar-layout">
                          <a href="./user-profile.php" class="svg-icon">
                              <i class="">
                      ...
                      <li class=" sidebar-layout">
                          <a href="./add-lead.php" class="svg-icon">
                              <i class="">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              ...
                              </i><span class="ml-2">Add Lead</span>
                          </a>
                      </li>


                      <li class=" sidebar-layout">
                          <a href="./manage-lead.php" class="svg-icon">
                              <i class="">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                                  </svg>
                                  
                              </i><span class="ml-2">Manage Lead</span>
                          </a>
                      </li>


                      <li class=" sidebar-layout">
                          <a href="./status-ordered.php" class="svg-icon">
                              <i class="">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              ...
                              </i><span class="ml-2">Ordered</span>
                          </a>
                      </li>


                      <li class=" sidebar-layout">
                          <a href="./status-inquiry.php" class="svg-icon">
                              <i class="">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class=" sidebar-layout">
                          <a href="../backend/pages-faq.php" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
